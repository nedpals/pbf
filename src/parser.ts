        ...
        next() {
            ...
            if (tokens) {
                for (let i = 1; i < tokens.length; i++) {
                    ...
                    if (tokens.index === this.lexer.lastIndex) {
                        this.lexer.lastIndex++;
                    }
...
// TODO: if there is a 3-or-more filters, it should be left-prec'd instead of the right to match stringify behavior
